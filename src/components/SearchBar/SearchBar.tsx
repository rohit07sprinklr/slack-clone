...
export default function SearchBar(){
    return (
        <div className="button" id="topbar_center_searchbox">
            ...
            <svg xmlnsXlink="button http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="topbar_center_searchbox_icon"><path fill="#FFFFFF" fill-rule="evenodd" d="M9 3a6 6 0 1 0 0 12A6 6 0 0 0 9 3ZM1.5 9a7.5 7.5 0 1 1 13.307 4.746l3.473 3.474a.75.75 0 1 1-1.06 1.06l-3.473-3.473A7.5 7.5 0 0 1 1.5 9Z" clip-rule="evenodd"></path></svg>
            Search Dummy
            </button>
